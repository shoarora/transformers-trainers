...
from transformers_trainers.callbacks import ElectraLayerSharingCallback
...
def train(cfg):
    ...
    g_config = ElectraConfig.from_pretrained(cfg.model.discriminator_name)
    ...
    callbacks = [ElectraLayerSharingCallback(lightning_module, **cfg.layer_sharing)]
